...
ALLOWED_IMPORTS = {
    ...
    "docx", "python-docx", "reportlab", "fpdf", "fpdf2",
    "openpyxl", "xlsxwriter", "xlrd", "xlwt",
    "PIL", "Pillow", "qrcode", "barcode", "python-barcode",
    "pptx", "python-pptx",
    "yaml", "pyyaml", "lxml", "xml", "html", "markdown",
    "requests", "urllib", "http", "aiohttp",
    "json", "csv", "datetime", "math", "random", "statistics",
    "collections", "itertools", "functools", "operator",
    "string", "textwrap", "re", "io", "base64",
}
