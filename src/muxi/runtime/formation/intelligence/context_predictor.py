...
class ContextPredictor:
    ...
    async def predict_preferences(
        self, storage_key: str, current_context: ConversationContext
    ) -> ContextPredictionResult:
        """
    ...
    async def _predict_time_based_preferences(
        self, storage_key: str, context: ConversationContext
    ) -> Optional[tuple]:
        ...
        if 6 <= hour_of_day < 12:
            preferences.append(
                ContextualPreference(
                    ...
                    confidence=ConfidenceScore(
                        value=0.6, data_points=1, recency=1.0, consistency=0.8
                    ),
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="quick",
                    confidence=ConfidenceScore(
                        value=0.65, data_points=1, recency=1.0, consistency=0.8
                    ),
                    context_conditions={"time_period": "morning"},
                    prediction_method="time_based",
                    timestamp=current_time,
        ...
        # Evening hours (18-22): More detailed, relaxed responses
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="detailed",
                    confidence=ConfidenceScore(
                        value=0.6, data_points=1, recency=1.0, consistency=0.7
                    ),
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="relaxed",
                    confidence=ConfidenceScore(
                        value=0.65, data_points=1, recency=1.0, consistency=0.7
                    ),
                    context_conditions={"time_period": "evening"},
                    prediction_method="time_based",
                    timestamp=current_time,
        ...
        if day_of_week in [5, 6]:  # Saturday, Sunday
            preferences.append(
                ContextualPreference(
                    ...
                    value="casual",
                    confidence=ConfidenceScore(
                        value=0.55, data_points=1, recency=1.0, consistency=0.7
                    ),
    ...
    async def _predict_topic_based_preferences(
        self, storage_key: str, context: ConversationContext
    ) -> Optional[tuple]:
        ...
        if any(
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    confidence=ConfidenceScore(
                        value=0.75, data_points=1, recency=1.0, consistency=0.9
                    ),
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="code_blocks",
                    confidence=ConfidenceScore(
                        value=0.7, data_points=1, recency=1.0, consistency=0.85
                    ),
                    context_conditions={"topic_category": "technical"},
                    prediction_method="topic_based",
                    timestamp=current_time,
        ...
        # Educational/learning topics
            ...
            keyword in topic_lower
            for keyword in ["learn", "explain", "understand", "tutorial", "guide", "how to"]
        ):
            preferences.append(
                ContextualPreference(
                    preference_type=PreferenceType.DETAIL_LEVEL,
                    value="comprehensive",
                    confidence=ConfidenceScore(
                        value=0.7, data_points=1, recency=1.0, consistency=0.8
                    ),
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="step-by-step",
                    confidence=ConfidenceScore(
                        value=0.75, data_points=1, recency=1.0, consistency=0.85
                    ),
                    context_conditions={"topic_category": "educational"},
                    prediction_method="topic_based",
                    timestamp=current_time,
        ...
        # Quick reference/lookup topics
            ...
            keyword in topic_lower
            for keyword in ["quick", "fast", "summary", "overview", "definition", "what is"]
        ):
            preferences.append(
                ContextualPreference(
                    preference_type=PreferenceType.DETAIL_LEVEL,
                    value="brief",
                    confidence=ConfidenceScore(
                        value=0.8, data_points=1, recency=1.0, consistency=0.9
                    ),
    ...
    async def _predict_session_based_preferences(
        self, storage_key: str, context: ConversationContext
    ) -> Optional[tuple]:
        ...
        if context.session_length > 20:
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="concise",
                    confidence=ConfidenceScore(
                        value=0.65, data_points=1, recency=1.0, consistency=0.75
                    ),
                    context_conditions={"session_type": "long"},
                    prediction_method="session_based",
                    timestamp=current_time,
        ...
        if len(context.previous_adaptations) > 5:
            preferences.append(
                ContextualPreference(
                    ...
                    confidence=ConfidenceScore(
                        value=0.75,
                        data_points=len(context.previous_adaptations),
                        recency=1.0,
                        consistency=0.9,
                    ),
    ...
    async def _predict_urgency_based_preferences(
        self, storage_key: str, context: ConversationContext
    ) -> Optional[tuple]:
        ...
        if context.urgency in ["high", "urgent", "emergency"]:
            preferences.append(
                ContextualPreference(
                    ...
                    value="brief",
                    confidence=ConfidenceScore(
                        value=0.9, data_points=1, recency=1.0, consistency=0.95
                    ),
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="immediate",
                    confidence=ConfidenceScore(
                        value=0.95, data_points=1, recency=1.0, consistency=0.98
                    ),
                    context_conditions={"urgency": context.urgency},
                    prediction_method="urgency_based",
                    timestamp=current_time,
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="numbered",
                    confidence=ConfidenceScore(
                        value=0.8, data_points=1, recency=1.0, consistency=0.85
                    ),
                    context_conditions={"urgency": context.urgency},
                    prediction_method="urgency_based",
                    timestamp=current_time,
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="comprehensive",
                    confidence=ConfidenceScore(
                        value=0.75, data_points=1, recency=1.0, consistency=0.8
                    ),
            ...
            preferences.append(
                ContextualPreference(
                    ...
                    value="friendly",
                    confidence=ConfidenceScore(
                        value=0.7, data_points=1, recency=1.0, consistency=0.75
                    ),
                    context_conditions={"urgency": "low"},
                    prediction_method="urgency_based",
                    timestamp=current_time,
    ...
    async def _predict_mood_based_preferences(
        self, storage_key: str, context: ConversationContext
    ) -> Optional[tuple]:
    ...
    async def _predict_task_based_preferences(
        self, storage_key: str, context: ConversationContext
    ) -> Optional[tuple]:
        ...
        if any(
            ...
            for keyword in ["debug", "error", "problem", "issue", "fix", "troubleshoot"]
        ):
            preferences.append(
                ContextualPreference(
                    preference_type=PreferenceType.RESPONSE_FORMAT,
                    value="step-by-step",
                    confidence=ConfidenceScore(
                        value=0.85, data_points=1, recency=1.0, consistency=0.9
                    ),
        ...
        # Design/planning tasks
            ...
            keyword in task_lower
            for keyword in ["design", "plan", "architecture", "structure", "organize"]
        ):
            preferences.append(
                ContextualPreference(
                    preference_type=PreferenceType.RESPONSE_FORMAT,
        ...
        # Implementation tasks
            ...
            keyword in task_lower for keyword in ["implement", "code", "build", "create", "develop"]
        ):
            preferences.append(
                ContextualPreference(
                    preference_type=PreferenceType.RESPONSE_FORMAT,
