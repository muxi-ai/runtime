...
class FallbackManager:
    ...
    async def _generate_error_message(
        ...
        error_messages = {
            ErrorType.NETWORK_TIMEOUT: "I'm experiencing network connectivity issues. Please try again in a moment.",
            ErrorType.AGENT_UNAVAILABLE: "The required service is temporarily unavailable. Please try again later.",
            ErrorType.LLM_RATE_LIMITED: "I'm currently experiencing high demand. Please wait a moment and try again.",
            ErrorType.MEMORY_FULL: "I'm running low on resources. Please try a simpler request.",
            ErrorType.AUTH_FAILED: "There's an authentication issue. Please check your credentials.",
            ErrorType.SYSTEM_OVERLOAD: "The system is currently overloaded. Please try again in a few minutes.",
            ErrorType.CONFIGURATION_ERROR: "There's a configuration issue. Please contact support.",
        }
    ...
    def _get_emergency_response(self, workflow: Any, error_type: ErrorType) -> Dict[str, Any]:
        ...
        return {
            ...
            'message': 'I apologize, but I\'m unable to process your request at this time. Please try again later or contact support.',
            'error_type': error_type.value,
            'workflow_id': getattr(workflow, 'id', None),
            'status': 'system_error'
        }
    ...
    async def _execute_simplified_workflow(
        ...
        return {
            ...
            'message': 'This response was generated using a simplified approach due to system constraints.'
        }
