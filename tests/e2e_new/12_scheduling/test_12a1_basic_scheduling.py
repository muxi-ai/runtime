...
def main():
    ...
    test = BaseSchedulingTest("12a1_basic_scheduling", "Test basic scheduling detection and creation")
    ...
    async def run_scheduling_test():
        ...
        nl_success = nl_results["successful_parses"] >= (nl_results["total_cases"] * 0.7)  # 70% success rate
        ...
        test.formatter.print_info(f"Natural language: {'PASSED' if nl_success else 'FAILED'} ({nl_results['successful_parses']}/{nl_results['total_cases']})")
