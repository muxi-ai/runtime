...
async def test_proactive_clarification():
    ...
    try:
        ...
        print("\n**User:** I want to plan a vacation. Ask me questions until you have enough information to suggest a complete itinerary.")
        
        response1 = await overlord.chat(
            message="I want to plan a vacation. Ask me questions until you have enough information to suggest a complete itinerary.",
            user_id="test_user",
        ...
        has_itinerary = any(word in final_response for word in 
                           ['itinerary', 'day 1', 'schedule', 'plan', 'suggestion', 'recommend'])
