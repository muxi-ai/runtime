...
from src.muxi.overlord.parallel import (
...
from src.muxi.overlord.parallel.types import (
    AgentCapability,
    ExecutionPlan,
    OptimizedWorkflow,
)
...
class TestParallelOptimization:
    ...
    async def test_bottleneck_detection(self, sample_workflow, sample_agents):
        ...
        from src.muxi.overlord.parallel.types import ExecutionPlan, ResourceAllocation
