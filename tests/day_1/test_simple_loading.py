...
class TestSimpleFormationLoading:
    ...
    def test_load_valid_formation(self):
    ...
    def test_load_nonexistent_formation(self):
    ...
    def test_load_invalid_yaml(self):
        ...
        with pytest.raises(Exception) as exc_info:
            formation.load("test-formations/invalid-syntax.yaml")
        
        # Could be yaml.YAMLError or wrapped in ConfigurationLoadError
        assert exc_info.value is not None
    
    def test_formation_state_after_load(self):
    ...
    def test_multiple_load_attempts(self):
