...
class KnowledgeChangeDetectionTest:
    ...
    def __init__(self):
        ...
        self.knowledge_dir = Path("../../test-formations/formation-knowledge/knowledge")
        self.temp_dir = Path("../../test-formations/temp-knowledge")
    ...
    async def load_formation(self):
        ...
        await self.formation.load("../../test-formations/formation-knowledge/formation.yaml")
