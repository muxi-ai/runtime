...
class TestLoggingValidation:
    ...
    def test_valid_full_config(self):
        ...
        config = {
            "system": {"level": "debug", "destination": "stdout"},
            "conversation": {
                "enabled": True,
                "streams": [{"transport": "stdout", "level": "info", "format": "jsonl"}],
            },
        }
    ...
    def test_valid_system_only(self):
        ...
        validator = FormationValidator()
        config = {"system": {"level": "warning", "destination": "/var/log/muxi-system.log"}}
        validator._validate_logging_config(config)
        assert not validator.result.errors
    ...
    def test_invalid_system_level(self):
        ...
        validator = FormationValidator()
        config = {"system": {"level": "invalid_level"}}
        validator._validate_logging_config(config)
    ...
    def test_invalid_conversation_stream_transport(self):
        ...
        config = {
            "conversation": {
                "enabled": True,
                "streams": [{"transport": "invalid_transport", "level": "info"}],
            }
        }
        validator._validate_logging_config(config)
    ...
    def test_file_stream_requires_destination(self):
        ...
        validator = FormationValidator()
        config = {
            "conversation": {"enabled": True, "streams": [{"transport": "file", "level": "info"}]}
        }
        validator._validate_logging_config(config)
    ...
    def test_trail_stream_requires_auth(self):
        ...
        validator = FormationValidator()
        config = {
            "conversation": {"enabled": True, "streams": [{"transport": "trail", "level": "info"}]}
        }
        validator._validate_logging_config(config)
    ...
    def test_warning_for_empty_streams(self):
        ...
        validator = FormationValidator()
        config = {"conversation": {"enabled": True, "streams": []}}
        validator._validate_logging_config(config)
        assert not validator.result.errors
...
class TestLoggingSystemDestination:
    ...
    def test_stdout_destination(self):
        ...
        validator = FormationValidator()
        config = {"system": {"level": "debug", "destination": "stdout"}}
        validator._validate_logging_config(config)
        assert not validator.result.errors
    ...
    def test_file_path_destination(self):
        ...
        validator = FormationValidator()
        config = {"system": {"level": "info", "destination": "/var/log/muxi/system.log"}}
        validator._validate_logging_config(config)
        assert not validator.result.errors
    ...
    def test_relative_path_destination(self):
        ...
        validator = FormationValidator()
        config = {"system": {"level": "info", "destination": "./logs/system.log"}}
        validator._validate_logging_config(config)
        assert not validator.result.errors
