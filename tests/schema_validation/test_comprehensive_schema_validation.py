...
class TestComprehensiveSchemaValidation:
    ...
    def test_maximum_complex_formation_config(self):
        ...
        # Should have some warnings about log exclude overriding log include
        ...
        boundary_formation = {
            ...
            'memory': {
                'buffer': {
                    ...
                    'multiplier': 1,      # Minimum valid multiplier
                    'vector_dimension': 1  # Minimum valid dimension
                }
            },
            'a2a': {
                'outbound': {
                    'default_retry_attempts': 0,   # Minimum valid retries
                    'default_timeout_seconds': 1   # Minimum valid timeout
                },
                'inbound': {
