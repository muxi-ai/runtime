        ...
        for artifact in response.artifacts:
            ...
            if hasattr(artifact, 'preview') and artifact.preview:
                artifact_dict["preview"] = {
                    "thumbnail": artifact.preview.thumbnail if hasattr(artifact.preview, 'thumbnail') else None
                }
            ...
            if is_text_file:
                ...
                if hasattr(artifact, 'data_url') and artifact.data_url:
                    ...
                    if not artifact.data_url.startswith('data:'):
                        ...
                        if artifact.format:
                            artifact_dict["data_url"] = f"data:application/{artifact.format};base64,{artifact.data_url}"
                        else:
                            artifact_dict["data_url"] = f"data:application/octet-stream;base64,{artifact.data_url}"
