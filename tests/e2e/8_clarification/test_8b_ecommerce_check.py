...
async def test_ecommerce_statement():
    ...
    try:
        ...
        has_error = (
            "error" in response_lower or "access" in response_lower or "denied" in response_lower
        )
        ...
        has_acknowledgment = any(
            ...
            for word in ["great", "help", "assist", "nice", "cool", "awesome", "good"]
        )
        ...
        mentions_ecommerce = any(
            ...
            for term in ["e-commerce", "ecommerce", "shop", "store", "product", "order"]
        )
        ...
        has_db_recommendation = any(
            db in response_lower for db in ["postgres", "mysql", "mongodb", "redis", "dynamodb"]
        )
        ...
        test_passed = (
            not has_error
            and not asks_clarification
            and not asks_what_project
            and has_db_recommendation
            and (mentions_ecommerce or mentions_tech)
        )
