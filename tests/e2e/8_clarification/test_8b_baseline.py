...
async def test_baseline_responses():
    ...
    try:
        ...
        print("   User: I'm a software developer")
        ...
        print("\n" + "="*40)
        print("\n### Analysis:")
        print("✓ Greeting responses captured")
        print("✓ Informational statements processed")
        if mentions_python:
            print("✓ Python context was remembered (mentions Python testing frameworks)")
        else:
            print("✗ Python context was NOT used (no Python-specific recommendations)")
