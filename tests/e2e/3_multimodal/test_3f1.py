"""
Test 3F1: PDF Formula Extraction - Mathematical Formula Recognition
...
async def test_3f1_main():
    """Test mathematical formula recognition"""
    print("\n=== Test 3F1: Mathematical Formula Recognition ===")
    ...
    # Test mathematical formula recognition
    print("\n📊 Testing mathematical formula recognition...")
    ...
    print("✅ Mathematical Formula Recognition test passed!")
...
if __name__ == "__main__":
    print("🧪 Running Test 3F1: Mathematical Formula Recognition (Sync Mode)")
    print("=" * 60)

    asyncio.run(test_3f1_main())

    print("\n🎉 Test 3F1 completed successfully!")
