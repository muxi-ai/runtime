...
async def test_enhanced_prompt_integration():
    ...
    # Specialization
    await overlord.chat(
        "I specialize in recommendation systems", user_id=test_user, use_async=False
    )
    await asyncio.sleep(3)
    ...
    await overlord.chat(
        "I'm currently working on improving our video recommendation algorithm",
        user_id=test_user,
        use_async=False,
    )
    await asyncio.sleep(3)
    ...
    # Personal preference
    await overlord.chat(
        "I prefer reading technical papers over watching video tutorials",
        user_id=test_user,
        use_async=False,
    )
    await asyncio.sleep(3)
    ...
    response = await overlord.chat(
        "What frameworks should I learn for my field?", user_id=test_user, use_async=False
    )
    ...
    response = await overlord.chat(
        "Can you summarize what you know about me and my work?", user_id=test_user, use_async=False
    )
