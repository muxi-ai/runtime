...
from src.muxi.memory.extractor import MemoryExtractor
...
class TestAgentExtraction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from src.muxi.agent import MCPServer
        ...
        with patch('muxi.mcp.service.MCPService.get_instance') as mock_get_instance:
