...
Sync version using audio files from test-docs
"""
...
async def test_speech_to_text():
    ...
    # Read audio file from test-docs
    audio_path = Path(__file__).parent.parent.parent / "test-docs" / "speech.m4a"
...
async def test_meeting_transcription():
    ...
    # Read meeting audio from test-docs
    audio_path = Path(__file__).parent.parent.parent / "test-docs" / "meeting.mp3"
    with open(audio_path, "rb") as f:
        audio_content = f.read()
