...
class TestVisibility:
    ...
    def observability_event(self, event_type: str, level: str, data: Dict[str, Any], description: str):
...
def get_response_with_visibility(coro, visibility: TestVisibility, step_description: str):
    """Helper to get response from async chat with visibility"""
...
def assert_with_visibility(condition: bool, message: str, visibility: TestVisibility, actual_value: Any = None):
