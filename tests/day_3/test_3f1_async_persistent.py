...
def test_async_pdf_persistent():
        ...
        async def monitor_request():
            ...
            while True:
                ...
                try:
                    ...
                    print(f"[{counter}s] Still running... (tracker check failed: {type(e).__name__})")
    ...
    time.sleep(2)  # Give a bit more time for any cleanup
