...
from src.muxi.clarification.planning_workflow_detector import (
    PlanningWorkflowDetector
)
from src.muxi.clarification.planning_continuation_manager import (
    PlanningContinuationManager
)
from src.muxi.clarification.types import (
...
class TestPhase4BIntegration:
    ...
    def test_session_creation_and_management(self):
        ...
        from src.muxi.clarification.types import PlanningWorkflowRequest
