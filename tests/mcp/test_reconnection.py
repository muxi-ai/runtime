...
from src.muxi.services.mcp.handler import MCPConnectionError
from src.muxi.services.mcp.reconnect_handler import ReconnectingMCPHandler
from src.muxi.services.mcp.reconnection import RetryConfiguration
...
class TestReconnection(unittest.TestCase):
    ...
    def _setup_transport_mock(self, failure_pattern=None):
        ...
        self.transport_factory_patch = patch(
            "muxi.services.mcp.handler.MCPTransportFactory", transport_factory_mock
        )
        ...
        self.list_tools_original = patch(
            "muxi.services.mcp.handler.MCPHandler.list_tools", new=self._mock_list_tools
        )
