...
from src.muxi.runtime.mcp.parser import ToolCall, ToolParser
from src.muxi.runtime.mcp.service import MCPService
...
class TestAgentToolIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from src.muxi.runtime.agent import Agent, MCPServer
