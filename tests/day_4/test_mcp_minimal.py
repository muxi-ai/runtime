...
def test_mcp_discovery():
    ...
    try:
        ...
        print(f"  - formation.yaml")
        print(f"  - agents/test_agent.yaml")
        print(f"  - mcp/filesystem.yaml")
        print(f"  - mcp/system.yaml")
        print(f"  - mcp/inactive.yaml")
        ...
        if hasattr(formation, '_mcp_config'):
            ...
            if 'servers' in formation._mcp_config:
                ...
                print(f"Expected active servers: 2")
