        ...
        def run_test():
            async def test_operations():
                ...
                assert any(term in response_lower for term in 
                          ["updated", "progress", "status", "changed", "modified"]) or \
                ...
                response = await overlord.chat(
                    "Mark the Linear issue as completed/done",
                    user_id="user1",
                    use_async=False
                )
                ...
                assert any(term in response_lower for term in 
                          ["completed", "done", "finished", "closed", "updated"]) or \
                       "linear" in response_lower, \
                ...
                assert "issue" in response_lower or "linear" in response_lower, \
