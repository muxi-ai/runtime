...
import os
os.environ["POSTGRES_DATABASE_URL"] = "postgresql://ran:@localhost:5432/muxi_framework"

from src.muxi.runtime.formation.formation import Formation
from src.muxi.runtime.formation.memory.credential_resolver import CredentialResolver, Credential, User
...
async def test_credential_isolation():
    ...
    deleted = await credential_resolver.delete_credential("alice_4d4_test", "github")
