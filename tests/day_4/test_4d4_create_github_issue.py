    ...
    try:
        ...
        def run_test():
            async def test_operations():
                ...
                if any(
                    term in response_lower
                    for term in ["repository", "not found", "access", "permission"]
                ):
                ...
                assert any(
                    term in response_lower
                    for term in ["issue", "created", "github", "successfully"]
