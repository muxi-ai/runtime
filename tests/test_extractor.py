...
from runtime.muxi.runtime.memory.extractor import MemoryExtractor
...
class TestAgentExtraction(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from runtime.muxi.runtime.agent import MCPServer
        ...
        with patch('muxi.runtime.mcp.service.MCPService.get_instance') as mock_get_instance:
