...
def load_enum_events() -> Dict[str, Set[str]]:
    ...
    enum_file = Path('src/muxi/datatypes/observability.py')
...
def main():
    ...
    for event in all_events:
        ...
        result = {
            ...
            'recommendation': '' if exists else get_recommendation(event_name, event_enum, event['context']),
