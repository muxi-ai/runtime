    ...
    def _load_tool_requirements(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "book_restaurant": {
                ...
                "priority_order": ["location", "date", "time", "party_size", "cuisine", "price_range", "special_requests"]
            },
            ...
            "book_flight": {
                ...
                "priority_order": ["departure", "destination", "departure_date", "passengers", "return_date", "class", "flexible_dates"]
            },
            ...
            "investment": {
                "context_requirements": {
                    ...
                    "investment_timeline": {
                        ...
                        "required": True,
                        "examples": ["short-term (< 2 years)", "medium-term (2-10 years)", "long-term (> 10 years)"],
                        "validation": {
                            "max_length": 100
                        }
                    },
                    ...
                    "current_portfolio": {
                        ...
                        "required": False,
                        "examples": ["mostly cash", "some stocks and bonds", "diversified portfolio"],
                        "validation": {
                            "max_length": 300
                        }
                    },
                ...
                "priority_order": ["risk_tolerance", "investment_timeline", "financial_goals", "current_portfolio", "income_level"]
            },
            ...
            "technical_explanation": {
                "context_requirements": {
                    ...
                    "specific_interest": {
                        ...
                        "required": True,
                        "examples": ["practical applications", "theoretical concepts", "implementation details"],
                        "validation": {
                            "max_length": 200
                        }
                    },
                ...
                "priority_order": ["technical_background", "specific_interest", "use_case", "time_available"]
            },
