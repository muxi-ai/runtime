...
## GOAL
Your goal is to spin up 3 parallel sub agents concurrently to implemeht one UI with variations, So that users can review and decide which one is better;
